...
public class ClanHallManagerNpcSiege extends Merchant
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (actualCommand.equalsIgnoreCase("banish_foreigner"))
		{
			...
			if (val.equalsIgnoreCase("list"))
				html.setFile("data/html/clanHallManagerSiege/banish-list.htm");
			else if (val.equalsIgnoreCase("banish"))
			{
				getClanHall().banishForeigners();
				html.setFile("data/html/clanHallManagerSiege/banish.htm");
			}
		...
		else if (actualCommand.equalsIgnoreCase("manage_vault"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManagerSiege/vault.htm");
		...
		else if (actualCommand.equalsIgnoreCase("door"))
		{
			...
			if (val.equalsIgnoreCase("open"))
			{
				...
				html.setFile("data/html/clanHallManagerSiege/door-open.htm");
			}
			else if (val.equalsIgnoreCase("close"))
			{
				getClanHall().openCloseDoors(false);
				html.setFile("data/html/clanHallManagerSiege/door-close.htm");
			}
			else
				html.setFile("data/html/clanHallManagerSiege/door.htm");
		...
		else if (actualCommand.equalsIgnoreCase("functions"))
		{
			...
			if (val.equalsIgnoreCase("tele"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManagerSiege/chamberlain-nac.htm");
					html.replace("%objectId%", getObjectId());
					player.sendPacket(html);
					return;
				}
			...
			else if (val.equalsIgnoreCase("support"))
			{
				...
				{
					html.setFile("data/html/clanHallManagerSiege/support" + chf.getLvl() + ".htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/clanHallManagerSiege/functions.htm");
		...
		else if (actualCommand.equalsIgnoreCase("manage"))
		{
			...
			if (val.equalsIgnoreCase("recovery"))
			{
				if (st.hasMoreTokens())
				{
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile("data/html/clanHallManagerSiege/functions-cancel.htm");
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile("data/html/clanHallManagerSiege/functions-apply.htm");
					...
					else if (val.equalsIgnoreCase("hp"))
					{
						...
						{
							html.setFile("data/html/clanHallManagerSiege/functions-used.htm");
						...
						html.setFile("data/html/clanHallManagerSiege/functions-apply_confirmed.htm");
						...
						switch (percent)
						{
							case 0:
								fee = 0;
								html.setFile("data/html/clanHallManagerSiege/functions-cancel_confirmed.htm");
								break;
						...
						if (!getClanHall().updateFunction(player, ClanHall.FUNC_RESTORE_HP, percent, fee, Config.CH_HPREG_FEE_RATIO))
							html.setFile("data/html/clanHallManagerSiege/low_adena.htm");
						else
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManagerSiege/edit_recovery.htm");
			...
			else if (val.equalsIgnoreCase("other"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile("data/html/clanHallManagerSiege/edit_other.htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile("data/html/clanHallManagerSiege/manage.htm");
				html.replace("%objectId%", getObjectId());
				player.sendPacket(html);
			}
		}
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManagerSiege/chamberlain.htm");
		...
		else if (actualCommand.equalsIgnoreCase("support_back"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManagerSiege/support" + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() + ".htm");
			html.replace("%mp%", (int) getStatus().getMp());
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		}
	...
	public void showChatWindow(Player player)
	{
		...
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
		html.setFile("data/html/clanHallManagerSiege/chamberlain" + ((getNpcTalkCond(player) == NpcTalkCond.OWNER) ? ".htm" : "-no.htm"));
		html.replace("%objectId%", getObjectId());
		player.sendPacket(html);
	}
	...
	private boolean validatePrivileges(Player player, int privilege)
	{
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile("data/html/clanHallManagerSiege/not_authorized.htm");
			player.sendPacket(html);
			return false;
		}
		return true;
