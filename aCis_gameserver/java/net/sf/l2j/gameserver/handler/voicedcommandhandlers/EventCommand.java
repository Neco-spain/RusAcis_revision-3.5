...
public class EventCommand implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String target)
	{
		if (command.equals("ctfinfo"))
		{
			...
			player.sendMessage("Capture the Flag event is not in progress.");
			return false;
		}
		...
		else if (command.equals("dminfo"))
		{
			...
			player.sendMessage("Deathmatch fight is not in progress.");
			return false;
		}
		...
		else if (command.equals("lminfo"))
		{
			...
			player.sendMessage("Last Man fight is not in progress.");
			return false;
		}
		...
		else if (command.equals("tvtinfo"))
		{
			...
			player.sendMessage("Team vs Team fight is not in progress.");
			return false;
		}
