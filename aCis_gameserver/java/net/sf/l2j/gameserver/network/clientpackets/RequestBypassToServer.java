...
public final class RequestBypassToServer extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		else  if  ( _command.startsWith("BuffEngine_Dispel;" )) 
		{ 
			final int intid, level;
...
//			StringTokenizer st =  new  StringTokenizer(params,",");
	...
	{
		html.setFile("data/html/mods/npcinfo/skills.htm");
		html.replace("%objid%", npc.getObjectId());
	...
	private static void showNpcInfoEffects(Player player, Npc npc, NpcHtmlMessage html, int page)
	{
		...
		// Load static Htm.
		html.setFile("data/html/mods/npcinfo/effects.htm");
		html.replace("%objid%", npc.getObjectId());
